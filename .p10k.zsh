# Generated by Powerlevel10k configuration wizard on 2024-03-03 at 00:45 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_CPU_ARCH_BACKGROUND=7
  ...
  function prompt_tmux_session_info() {
    # Check if zsh is in a tmux session
    if [ -n "${TMUX}" ]; then
